...
def stratified_split(
    rows: list[dict[str, str]], target: str, test_size: float, seed: int
) -> tuple[list[dict[str, str]], list[dict[str, str]]]:
...
def time_split(
    rows: list[dict[str, str]], time_col: str, test_size: float
) -> tuple[list[dict[str, str]], list[dict[str, str]]]:
...
def group_split(
    rows: list[dict[str, str]], group_col: str, test_size: float, seed: int
) -> tuple[list[dict[str, str]], list[dict[str, str]]]:
