...
def _build_weights(g: pd.DataFrame, asset_col: str, signal_col: str, top_frac: float, mode: str) -> pd.Series:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build a simple signal-ranked long-short backtest from long-form data."
    )
