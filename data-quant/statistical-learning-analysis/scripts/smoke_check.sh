...
out_root = Path(os.environ.get("DATA_QUANT_EXAMPLE_OUT", "examples/out"))
gate_paths = [
    out_root / "alpha/alpha_research_gate.json",
    out_root / "portfolio/portfolio_construction_gate.json",
]
