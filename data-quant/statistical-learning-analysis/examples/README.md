...
Each shell writes JSON + Markdown outputs under `examples/out/<chain>/` by default. Set
`DATA_QUANT_EXAMPLE_OUT=/absolute/run/path` to keep generated acceptance artifacts outside the Skill tree.
