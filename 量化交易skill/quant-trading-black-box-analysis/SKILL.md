...
The skill is based on the local Markdown chapter summaries for *打开量化投资的黑箱（第二版）*. For exact chapter-level wording, inspect `/home/fufu/Code/Skills/量化交易skill/md`.
