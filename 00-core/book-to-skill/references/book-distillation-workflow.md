...
```bash
python3 /home/fufu/Code/Skills/source/书籍提炼skill/book-to-skill/scripts/init_book_project.py \
...
```bash
python3 /home/fufu/Code/Skills/source/书籍提炼skill/book-to-skill/scripts/pdf_text_extract.py \
  /path/to/book.pdf \
...
```bash
python3 /home/fufu/Code/Skills/source/书籍提炼skill/book-to-skill/scripts/build_source_coverage_map.py <book-project> --force
```
...
```bash
python3 /home/fufu/Code/Skills/source/书籍提炼skill/book-to-skill/scripts/check_book_bundle.py <book-project> --strict
...
```bash
python3 /home/fufu/Code/Skills/source/书籍提炼skill/book-to-skill/scripts/link_generated_skill.py \
  <book-project>/<generated-skill>
```
