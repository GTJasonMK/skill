...
| Chapter coverage or exact source lookup | User asks whether a chapter/topic is covered or wants source traceability | `source-coverage.md` | Local `/home/fufu/Code/Skills/source/量化交易skill/md` chapter summaries |
